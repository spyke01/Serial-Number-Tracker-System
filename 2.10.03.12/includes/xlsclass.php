...
EOH;
        ...
        */
        ...
        function writeLine($line_arr, $bold = 0)
        {
            if($this->state!="OPENED")
            {
                $this->error="Error : Please open the file.";
            ...
            foreach($line_arr as $col) {
				if ($bold == 1) { fwrite($this->fp,"<td class=\"xl24\" width=\"64\" style=\"font-weight:bold;\">$col</td>"); }
        ...
        * @Return : Void
        */
        function writeCol($value, $bold = 0)
        {
            if($this->state!="OPENED")
            {
                $this->error="Error : Please open the file.";
			...
			if ($bold == 1) { fwrite($this->fp,"<td class=\"xl24\" width=\"64\" style=\"font-weight:bold;\">$value</td>"); }
			else { fwrite($this->fp,"<td class=\"xl24\" width=\"64\">$value</td>"); }
        }
    }
?> 